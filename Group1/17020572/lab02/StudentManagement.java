...
public class StudentManagement {
    ...
    public static void main (String[] args){
        ...
        sinhVien.arr[3] = new Student("thiB","17020002","hihi","INT22045");
        sinhVien.arr[4] = new Student("chipheo","17020003","doiNo","INT22045");
    ...
    public void studentByGroup()
    {
        ...
        for(int i=0;arr[i]!=null;i++)
        {
            ...
            for(int k=i+1;arr[k]!=null;k++)
            {
                if(k == n-1) {
                    return;
                }
                if(sameGroup(arr[k],arr[i])==false && arr[k].check == true) {
                    i=k-1;
                    break;
                }
            }
    ...
    public void removeStudent(String id)
    {
        for(int i=0; arr[i]!=null; i++)
        {
            if(arr[i].getId("17020202").equals(id))
            {
